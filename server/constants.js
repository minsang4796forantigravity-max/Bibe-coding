const UNITS = {
    ...
    // === 2 코스트 ===
    GOBLIN: { id: 'goblin', name: 'Goblins', cost: 2, hp: 140, damage: 100, speed: 2.4, range: 1.0, attackSpeed: 1.1, type: 'ground', targets: 'ground', count: 5, meleeCount: 3, spearCount: 2, rarity: 'normal' },
...
module.exports = { UNITS, EVOLVED_STATS, GAME_CONFIG, EMOTES, BOOSTERS, RARITY_WEIGHTS };
